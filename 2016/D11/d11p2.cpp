...
int main() {
    ...
    // Append extra items for Part Two: elerium and dilithium on first floor
    rawItems.emplace_back(1, "elerium", true);
    rawItems.emplace_back(1, "elerium", false);
    rawItems.emplace_back(1, "dilithium", true);
    rawItems.emplace_back(1, "dilithium", false);
